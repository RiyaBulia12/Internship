<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="product-category.aspx.cs" Inherits="Default" %>
                    ...
                    <ItemTemplate>
                        <li class="col-sm-2 li_cat">
                            ...
                            <h4 class="panel-title">
                                                <asp:LinkButton ID="linkc" Text='<%#Eval("cat_name") %>' CommandArgument='<%#Eval("id_cat") %>' CommandName="linkCate" runat="server" OnCommand="gotoshop" /> </h4>
                        </li>
                    </ItemTemplate>
                </asp:Repeater>
            </ul>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 padding-right bg">
                    <div class="features_items">
                        <!--features_items-->
                        <h2 class="title text-center border">Features Items</h2>
                                            ...
                                            <div class="product-overlay">
                                                <div class="overlay-content">
                                                   <h2><i class="fa fa-inr"></i><%#Eval("CatPro_price") %></h2>
                                                    ...
                                                    <asp:LinkButton CommandArgument='<%#Eval("CatPro_id")%>' class="btn btn-default add-to-cart" ID="Info" runat="server" OnCommand="cmdInfo"><i class="fa fa-info-circle"></i>Info</asp:LinkButton>
