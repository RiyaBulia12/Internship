...
import com.example.progressedinternship.helper.NavDrawerListAdapter;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		FontHelper.applyFont(this, findViewById(R.id.list_slidermenu), "fonts/Tautz.ttf");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_cart:
			...
			Intent intent = new Intent(MainActivity.this, Fragement_mycart.class);
