package com.example.progressedinternship.util;

import com.example.progressedinternship.app.AppConst;
import com.example.progressedinternship.picasa.model.Category;
...
public class PrefManager {
	...
	private static final String PREF_NAME = "Fuzion Fab";

	// Google's username
	private static final String KEY_GOOGLE_USERNAME = "riyabulia12";

	// No of grid columns
	private static final String KEY_NO_OF_COLUMNS = "2";

	// Gallery directory name
	private static final String KEY_GALLERY_NAME = "Fuzion Fab";
